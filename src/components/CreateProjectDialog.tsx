      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit((v) => create.mutate(v))} className="space-y-4">
            ...
            <FormField control={form.control} name="bidDueDate" render={({ field }) => (
            ...
            <FormField control={form.control} name="notes" render={({ field }) => (
              <FormItem>
                ...
                <FormControl><Textarea placeholder="Add any initial notes..." className="resize-none" {...field} /></FormControl>
                <FormMessage />
              </FormItem>
            )} />
